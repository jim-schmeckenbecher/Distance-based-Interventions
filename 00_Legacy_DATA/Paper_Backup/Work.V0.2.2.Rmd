...
Background: Distance based Interventions against suicidal thoughts and injuries are of an increasing prevalence and potential importance element in a stepped care approach against the highly prevalent suicidal toughs and injuries.

Aims: This meta-analysis aims to give the most comprehensive quantitative synthesis possible to current effectiveness of distance based interventions against suicidal thoughts and injuries.

Methods (data source; study selection, syntheses approach): For this analysis Web of Science Scpous and Pubmed were systematically searched for all distance based interventions, including all types of distances interventions and all types of suicidal outcome measures, synthesising the data using an robust variance estimation corrected multilevel approach to return unbiased estimations of the effectiveness of interventions.

Results: Overall distance based interventions have shown themself to be as effective as face-to-face treatment and internet based cognitive behavioural treatment against suicidal thoughts, but with limited effectiveness against suicidal acts. Human involvement had no impact on the effectiveness of interventions.

Conclusion: DBI are an effective tool in a step care approach, against suicidal thoughts, but not necessarily against suicidal acts. Future research should focus on the development of autonomous programs, in favour of human involved programs, as both were comparatively effective, with autonomous programs being cheaper and more scalable.
...
The prevalence of SITB is also a provider challenge, as only 17% to 56% of individuals presenting SITB receive the needed treatment [@bruffaerts2011]. Given the prevalence of SITB worldwide and the low treatment coverage it is self evident that the current system must be supplemented by more efficient ways of providing care. Efficiency of mental health services being an increasing demand [@knapp2020] and for SITB the leading constraint to receive help [@bruffaerts2011]. With the recommendation to just allocate more resources ignoring the global nature of the problem, as this option is only open to the wealthiest countries. Besides financial efficiency the supplementing system should at best be available anywhere, as local unavailability is the second leading restriction to receiving treatment for SITB [@bruffaerts2011].

These pre-requites for a new type of intervention makes autonomous distance based interventions, i.e. websites, Applications, seem like the perfect choice, being efficient and scalable [@batterham2015]. But, given that thwarted belongingness is a major factor in developing suicidal ideation [@joiner2005], human involvement in programs may leading to higher efficacy. Therefore human involved distance based interventions should not be pre-excluded. As such we included all distance based interventions (DBI), from human involved letters and phone calls to autonomous apps and websites. With both forms of DBI promise cost savings and high availability [@batterham2015][@carter2005], autonomous programs promise better scalability, with a high upfront cost, while human involved programs have limited scalability, but negligible upfront costs.

From a meta-analytical perspective to include both autonomous and human involved programs against all types of self injuries thoughts and behaviours (SITB), makes this meta-analysis comprehensive, given it the advantage of including: (a) At least 20 - 30 years [@evans1999] [@motto2001] of research history. (b) Including all types of SITB may allow differential treatment recommendations. (c) Both human and autonomous are now, due to COVID-19, more relevant and accepted than ever, as these are inherently also socially distanced. Making recommendations to the use of human involved programs acutely relevant for clinical practice and recommendations for future research into autonomous programs more than ever.

To achieve the goals of creating the best possible clinical and research recommendations, four supplemental research questions were formulated: (a) Does Effectiveness of interventions differ pending suicidal toughs vs. suicidal behaviours, (b) Can a difference be observed pending different control Groups? (c) Can a difference be observed pending human involvement in the intervention and (d) does effectiveness of interventions decrease between post-intervention and follow up measurements?
...
Lastly that the dataset also included internet based cognitive behavioural (iCBT)treatments, but still returned rather homogeneous results, was surprising, but the point of comparability of all internet based interventions, including iCBT is enforced by a meta-analysis reporting comparable results of iCBT's against suicidal ideation [@buscher2020c] compared to the here included results against suicidal thoughts, which in included ideation and planning.
...
A further advise would be the development of programs that are akin in frequency and intensity to actual psychotherapy, here the already proven low frequency concepts could be extended. And as autonomous programs are as effective as internet based cognitive behavioural treatments (iCBT), but more scalable, archiving an good Return of Investment (ROI) is possible. Making DIB an interesting option for industrial partners, which have development expertise and resources not available to most public institutions. Especially the knowledge on how to keep users engaged in the program seems important; seeing that most programs evaluated in this meta-analysis had elevated rates of user attrition, despite of paying their participants.
