...
A further advise would be the development of programs that are akin in frequency and intensity to actual psychotherapy, here the already proven low frequency concepts could be extended. And as autonomous programs are effective and scalable archiving a Return of Investment (ROI) could be possible. Making DIB an interesting option for industrial partners, which have development expertise and resources not available to most public institutions. Especially the knowledge on how to keep users engaged in the program seems important; seeing that most programs evaluated in this meta-analysis had elevated rates of user attrition, despite of paying their participants.
